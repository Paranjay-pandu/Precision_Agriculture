...
# Assuming a certain area (for example, 100000 square centimeters)
area_cm2 = 100000  # Area in square centimeters

# Calculate the water volume in milliliters for the given area
df['Water_volume_mL'] = df['Water_predicted'] * area_cm2 * 0.1

# Check the Water_volume_mL column
print("Water volume in milliliters (first 5 rows):")
print(df['Water_volume_mL'].head())
